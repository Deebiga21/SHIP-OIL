...
const getShipSvg = (type, markerColor) => {
  const t = type ? type.toLowerCase() : '';
  const baseOuterHull = `<path d="M12 1L18 7V22C18 22.5 17.5 23 17 23H7C6.5 23 6 22.5 6 22V7L12 1Z" fill="#1e293b" />`;
  const baseInnerDeck = `<path d="M12 2.5L16.5 7.5V22H7.5V7.5L12 2.5Z" fill="${markerColor}" />`;
  const baseBridge = `
    <rect x="7" y="18" width="10" height="3.5" rx="1" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="0.5" />
    <rect x="8" y="18.5" width="8" height="1.5" fill="#64748b" rx="0.5" />
  `;

  if (t.includes('container')) {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" style="filter: drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">
        ${baseOuterHull}
        ${baseInnerDeck}
        ${baseBridge}
        <rect x="8.5" y="7" width="7" height="2.5" fill="#ef4444" rx="0.2" />
        <rect x="8.5" y="7" width="7" height="1" fill="#fca5a5" opacity="0.4" />
        <rect x="8.5" y="10" width="7" height="2.5" fill="#3b82f6" rx="0.2" />
        <rect x="8.5" y="10" width="7" height="1" fill="#93c5fd" opacity="0.4" />
        <rect x="8.5" y="13" width="7" height="2.5" fill="#10b981" rx="0.2" />
        <rect x="8.5" y="13" width="7" height="1" fill="#6ee7b7" opacity="0.4" />
        <rect x="8.5" y="16" width="7" height="1.5" fill="#f59e0b" rx="0.2" />
        <rect x="8.5" y="16" width="7" height="0.5" fill="#fcd34d" opacity="0.4" />
        <line x1="12" y1="2.5" x2="12" y2="6.5" stroke="rgba(255,255,255,0.4)" stroke-width="0.5" />
      </svg>
    `;
    ...
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" style="filter: drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">
        ${baseOuterHull}
        <path d="M12 2.5L16.5 7.5V22H7.5V7.5L12 2.5Z" fill="${markerColor}" />
        ${baseBridge}
        <circle cx="12" cy="8.5" r="2.5" fill="#cbd5e1" stroke="#94a3b8" stroke-width="0.5" />
        <circle cx="12" cy="8.5" r="1.5" fill="#f1f5f9" />
        <circle cx="12" cy="13.5" r="2.5" fill="#cbd5e1" stroke="#94a3b8" stroke-width="0.5" />
        <circle cx="12" cy="13.5" r="1.5" fill="#f1f5f9" />
        <line x1="12" y1="5" x2="12" y2="17" stroke="#64748b" stroke-width="1" />
        <line x1="10" y1="11" x2="14" y2="11" stroke="#64748b" stroke-width="1" />
      </svg>
    `;
  } else if (t.includes('bulk')) {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" style="filter: drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">
        ${baseOuterHull}
        ${baseInnerDeck}
        ${baseBridge}
        <rect x="8.5" y="7" width="7" height="3" fill="#94a3b8" stroke="#475569" stroke-width="0.5" />
        <line x1="8.5" y1="8.5" x2="15.5" y2="8.5" stroke="#475569" stroke-width="0.5" />
        <rect x="8.5" y="11" width="7" height="3" fill="#94a3b8" stroke="#475569" stroke-width="0.5" />
        <line x1="8.5" y1="12.5" x2="15.5" y2="12.5" stroke="#475569" stroke-width="0.5" />
        <rect x="8.5" y="15" width="7" height="2" fill="#94a3b8" stroke="#475569" stroke-width="0.5" />
      </svg>
    `;
  } else if (t.includes('tug') || t.includes('support')) {
    return `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" style="filter: drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">
        <path d="M12 3L17 7V19C17 20 16 21 15 21H9C8 21 7 20 7 19V7L12 3Z" fill="#1e293b" />
        <path d="M12 4.5L15.5 7.5V19.5H8.5V7.5L12 4.5Z" fill="${markerColor}" />
        <rect x="8" y="7" width="8" height="3.5" rx="1" fill="#f1f5f9" stroke="#cbd5e1" stroke-width="0.5" />
        <rect x="9" y="7.5" width="6" height="1.5" fill="#64748b" rx="0.5" />
        <circle cx="12" cy="15" r="1.5" fill="#94a3b8" />
        <line x1="12" y1="13" x2="12" y2="17" stroke="#475569" stroke-width="0.5" />
      </svg>
    `;
  }
  ...
  return `
    <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" style="filter: drop-shadow(0px 2px 2px rgba(0,0,0,0.4));">
      ...
      ${baseInnerDeck}
      ${baseBridge}
      <line x1="12" y1="2.5" x2="12" y2="7.5" stroke="rgba(255,255,255,0.4)" stroke-width="0.5" />
    </svg>
  `;
};
...
export default function InteractiveMap({
  ...
  useEffect(() => {
    ...
    if (!mapInstanceRef.current) {
      ...
      // Force recalculation of map container size in case CSS loads asynchronously
      setTimeout(() => {
        if (mapInstanceRef.current) {
            ...
            html: `
              <div class="relative flex items-center justify-center cursor-pointer transform hover:scale-125 transition-transform">
                <div class="w-9 h-9 rounded-full flex items-center justify-center ${
                  ...
                  ${getShipSvg(vessel.type, markerColor)}
                </div>
                ${
                  isTopSuspect
  ...
  return (
    <div className="relative w-full h-full bg-[#EBF1F5] overflow-hidden">
      ...
      <div className="absolute top-4 left-4 z-20 flex flex-col space-y-2">
        <div className="backdrop-blur-md p-3 rounded-xl border border-slate-200 text-xs w-60 shadow-lg bg-white/95 text-slate-800">
