      ...
      <div className="space-y-5">
        ...
        <div className="space-y-2">
          ...
          <label className="font-semibold text-slate-800 flex items-center justify-between font-mono mt-3">
            ...
            <span className="text-sky-700 font-bold">{windDir}Â°</span>
          </label>
          <input
            type="range"
            min={0}
        ...
        <div className="space-y-2 border-t border-slate-200 pt-4">
          ...
          <label className="font-semibold text-slate-800 flex items-center justify-between font-mono mt-3">
            ...
            <span className="text-emerald-700 font-bold">{currentDir}Â°</span>
          </label>
          <input
            type="range"
            min={0}
          ...
          >
            {BONN_OIL_TYPES.map((t) => (
              <option key={t.code} value={t.code}>
                Code {t.code}: {t.name} ({t.thicknessMicrons} Î¼m)
              </option>
            ))}
          </select>
        </div>
