        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200">
            ...
            <div className="text-base font-bold text-slate-900 font-mono mt-0.5">
              {slickData.areaKm2} <span className="text-xs font-normal text-slate-500">kmÂ²</span>
            </div>
          </div>
          ...
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200">
            ...
            <div className="text-base font-bold text-amber-700 font-mono mt-0.5">
              {slickData.volumeM3} <span className="text-xs font-normal text-slate-500">mÂ³</span>
            </div>
          ...
          <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200">
            ...
            <div className="text-sm font-bold text-slate-900 font-mono mt-0.5">
              {slickData.thicknessMicrons} <span className="text-xs font-normal text-slate-500">Î¼m</span>
            </div>
