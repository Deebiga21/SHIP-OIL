    ...
    <div className="glass-panel p-4 rounded-xl border border-slate-200 text-xs shadow-md bg-white text-slate-800 flex flex-col space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs font-mono">
        ...
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 space-y-1">
          ...
          <div className="text-[10px] text-slate-500">Dir: {weatherData.windDirDeg}° ({weatherData.windSpeedKmh} km/h)</div>
        </div>
        ...
        <div className="bg-slate-50 p-2.5 rounded-lg border border-slate-200 space-y-1">
          ...
          <div className="text-[10px] text-slate-500">Dir: {weatherData.currentDirDeg}°</div>
        </div>
